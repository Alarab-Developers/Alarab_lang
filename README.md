...
# اللغة البرمجية العربية (Arabic Programming Language) 🌙️⚔️ (ع)



## المشروع :
* الرخصة : جنو العمومية الاصدار 2    GPL.2V.
* المشروع : لغة برمجة عربية.
* اسم المشروع : اللغة البرمجية العربية.
* المطور : سيف حسين.
* الاصدار : 8 الثامن (تاريخ الاصدار : 27 من ذو القعدة 1447 سنة هجرية).
...
تتميز **اللغة البرمجية العربية** بسهولة ألفاظها والتعامل معها حتي في العمليات الرياضية مثال:
*   متغير س = 10
*   متغير ص = 5
* احسب = س + ص + 20
* الناتج = 35
